...
public class DemoTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputSource inputSource = new InputSource(new FileReader("D:\\Tool\\element\\config-element.xml"));
        SAXSource source = new SAXSource(xmlReader, inputSource);

        Unmarshaller unmarshaller = jc.createUnmarshaller();
        FilterConfig filterConfig = (FilterConfig) unmarshaller.unmarshal(source);
//        filterConfig.getPivot().forEach(p->p.getContent().forEach(s->{
//        	if("org.element.ref.Measurements".equals(s.getClass().getName())){
//        		System.out.println("dd");
//        	System.out.println(((Measurements)s).getMeasurement().getFunction());
//        	}
//        	}));
//        filterConfig.getPivot().forEach(p->p.get);
